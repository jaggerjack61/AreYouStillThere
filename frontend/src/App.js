    ...
    <div className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="sidebar-nav">
          ...
          <NavLink to="/request-logs" className="nav-item">
            <svg viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M5 3a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2V8.414A2 2 0 0016.414 7L13 3.586A2 2 0 0011.586 3H5zm2 5a1 1 0 000 2h6a1 1 0 100-2H7zm0 4a1 1 0 100 2h6a1 1 0 100-2H7z" clipRule="evenodd"/></svg>
            Request Logs
          </NavLink>

          <span className="nav-group-label">Notifications</span>
          <NavLink to="/smtp-config" className="nav-item">
            <svg viewBox="0 0 20 20" fill="currentColor"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/></svg>
            SMTP Config
          </NavLink>
          <NavLink to="/notification-settings" className="nav-item">
            <svg viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a6 6 0 00-6 6v3.586l-.707.707A1 1 0 004 14h12a1 1 0 00.707-1.707L16 11.586V8a6 6 0 00-6-6zM10 18a3 3 0 01-3-3h6a3 3 0 01-3 3z"/></svg>
            Policies
          </NavLink>
          <NavLink to="/notification-logs" className="nav-item">
